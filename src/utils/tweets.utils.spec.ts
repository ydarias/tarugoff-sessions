    ...
    const tweets: Tweet[] = [
        {
            ...
            "text": "RT @tarugoconf: No dejes para mañana lo que puedas hacer hoy. Envía una propuesta a la #tarugoff, el Open Space de la #tarugo20 y devuelve…",
            "user": "javilopezcam",
            "isRetweet": true
        },
        {
            ...
            "text": "Mis favoritas para la #tarugoff, el open space de la @tarugoconf, son #Charlaca1 y #Charlaca8… https://t.co/3Y1sYrqlV1",
            "user": "juanmi_tw",
            "isRetweet": false
        }
    ];
